...
echo ""
log_info "Next steps:"
echo "1. Tag this EC2 instance with:"
echo "   - CodeDeploy = ResilienceAtlas"
echo ""
echo "   NOTE: This tag is used ONLY for CodeDeploy targeting."
echo "   Other instances can have Project=ResilienceAtlas without"
echo "   receiving deployments."
echo ""
echo "   This single instance will host BOTH staging and production:"
echo "   - Directories: /opt/resilienceatlas-staging, /opt/resilienceatlas-production"
echo "   - Ports: Staging (3000/3001), Production (4000/4001)"
echo ""
...
echo ""
echo "3. Both deployment groups (staging and production) will deploy to this instance"
echo ""
