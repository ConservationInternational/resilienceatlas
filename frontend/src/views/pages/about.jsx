        ...
        <article>
          <Row id="using_the_atlas">
            ...
            <Column small={12} medium={6}>
              ...
              <p>
                The <NavLink to="/journeys">journeys</NavLink> provide a curated pathway to explore
                some of the different data layers to gain new insights into the resilience of
                particular systems and places. The journeys demonstrate how to use the RESILIENCE
                ATLAS analytical tool and database to arrive at insights, and hopefully will
                stimulate you to explore the data further.
              </p>

              <p>
                Take a look through the data <NavLink to="/map">map</NavLink>, don’t be overwhelmed,
                and start creating your own journeys and generating your own insights.
              </p>
            </Column>
          </Row>
        </article>
          ...
          <Row>
            <Column small={12} medium={12}>
              ...
              <p>
                ...
                <NavLink to="map">main map page.</NavLink>
              </p>
              <p>
