    ...
    >
      <defs>
        <symbol id="icon-facebook" viewBox="0 0 542 1024">
          ...
          <path
            className="path1"
            d="M350.871 1017.615v-464.173h159.322l23.974-180.887h-183.296v-115.531c0-52.405 14.878-88.064 91.738-88.064h98.003v-161.912c-16.986-2.108-75.113-7.048-142.758-7.048-141.372 0-238.11 84.329-238.11 239.134v133.421h-159.744v180.887h159.804v464.173h191.066z"
          />
        </symbol>
        ...
        <symbol id="icon-twitter" viewBox="0 0 1243 1024">
          ...
          <path
            className="path1"
            d="M1057.646 152.649c50.834-30.135 89.966-77.897 108.251-134.802-47.543 27.794-100.206 48.274-156.233 59.099-44.91-47.323-108.763-76.946-179.493-76.946-136.046 0-246.126 109.129-246.126 243.712 0 19.017 2.194 37.742 6.363 55.589-204.361-10.386-385.609-107.301-507.026-254.683-20.992 35.986-33.134 77.824-33.134 122.514 0 84.553 43.447 159.159 109.422 202.898-40.229-1.463-78.263-12.434-111.397-30.574-0.146 1.024-0.146 2.048-0.146 3.072 0 118.053 84.846 216.503 197.339 238.958-20.626 5.632-42.423 8.631-64.805 8.631-15.872 0-31.232-1.463-46.299-4.389 31.305 96.841 122.149 167.278 229.815 169.253-84.261 65.39-190.318 104.448-305.664 104.448-19.749 0-39.497-1.243-58.661-3.511 108.837 69.193 238.153 109.495 377.051 109.495 452.462 0 699.977-371.419 699.977-693.541 0-10.533-0.293-21.065-0.731-31.451 48.055-34.377 89.746-77.312 122.734-126.245-44.105 19.383-91.575 32.549-141.312 38.4z"
          />
        </symbol>
        ...
        >
          ...
          <g>
            ...
            <g>
              <path d="M5.515 6.192l-.707-.707 4.95-4.95.706.708z" />
              <path d="M10.654 6.142h-1.17V1.465h1.17v4.677zM4.808 1.465V.295h5.846v1.17H4.808z" />
            </g>
          </g>
        </symbol>
