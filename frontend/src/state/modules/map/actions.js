...
export const SET_MAP_LAYER_GROUPS_INTERACTION =
  'map / SET_LAYER_GROUPS_INTERACTION';
export const SET_MAP_LAYER_GROUPS_INTERACTION_LATLNG =
  'map / SET_LAYER_GROUPS_INTERACTION_LATLNG';
