...
- [Node.js](https://nodejs.org/) v20.18.1 as the runtime
...
1. Make sure you you have [Node.js](https://nodejs.org/en/) v20.18.1 or later installed
...
6. Use the correct Node.js version for this app by running `nvm use`; if you didn't install NVM (step 2), then manually install Node.js v20.18.1 as described in `.nvmrc`
