...
class Layer < ApplicationRecord
  ...
  VALID_PROVIDERS = ["arcgis_feature", "cog", "esri", "gee", "martin", "wms", "wmts", "xyz tileset"].freeze
  validates :layer_provider, inclusion: {
    in: VALID_PROVIDERS,
    message: "must be one of: arcgis_feature, cog, esri, gee, martin, wms, wmts, or xyz tileset",
    allow_nil: false
