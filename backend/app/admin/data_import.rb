ActiveAdmin.register DataImport do
  ...
  index title: "Data Uploads" do
    # Custom upload interface injected before the table
    div class: "index_content" do
      div id: "upload-section", class: "panel", style: "background: #f9f9f9; border: 2px solid #2c3e50; margin-bottom: 30px;" do
        h3 "Upload Data", style: "color: #2c3e50; margin-top: 0;"
        
        para "Select a file and specify its type to upload it to the appropriate location. After upload, configure layers manually to use the uploaded data.", style: "margin-bottom: 20px;"
        
        # Use insert_tag to render raw HTML form
        insert_tag ActiveAdmin::Views::UnsafeHtml, %{
          <form action="#{upload_file_admin_data_imports_path}" method="post" enctype="multipart/form-data" id="unified-upload-form" style="margin-top: 20px;">
